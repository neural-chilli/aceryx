# Spec 029 — Trigger Plugin Framework — Gap Audit

- Spec file: `docs/specs/029-trigger-plugin-framework.md`
...
- [x] `trigger_checkpoints` has migration/code evidence.
- [x] `trigger_instances` has migration/code evidence.
### Remaining work
...
- [ ] `DELETE /api/v1/admin/triggers/:id/checkpoints` route not found (likely unimplemented or renamed).
- [x] `GET /api/v1/admin/triggers` route evidence found (matched as `GET /api/v1/admin/triggers`).
- [ ] `GET /api/v1/admin/triggers/:id` route not found (likely unimplemented or renamed).
- [ ] `GET /api/v1/admin/triggers/:id/checkpoints` route not found (likely unimplemented or renamed).
- [ ] `POST /api/v1/admin/triggers/:id/restart` route not found (likely unimplemented or renamed).
- [ ] `POST /api/v1/admin/triggers/:id/stop` route not found (likely unimplemented or renamed).
### Remaining work

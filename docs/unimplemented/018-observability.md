# 018 — Observability — Gap Audit

- Spec file: `docs/specs/018-observability.md`
...
- [ ] `GET /health` route not found (likely unimplemented or renamed).
- [ ] `GET /healthz` route not found (likely unimplemented or renamed).
- [x] `GET /metrics` route evidence found (matched as `GET /metrics`).
- [ ] `GET /readyz` route not found (likely unimplemented or renamed).
### Remaining work
...
- [x] `dag_eval` has builder/engine code references.
### Remaining work

# Spec 035 — QuantLib WASM Plugin — Gap Audit

- Spec file: `docs/specs/035-quantlib-wasm.md`
...
- [x] `json` has builder/engine code references.
- [x] `select` has builder/engine code references.

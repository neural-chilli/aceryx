# 011 — Audit Trail — Gap Audit

- Spec file: `docs/specs/011-audit-trail.md`
...
- [ ] `GET /cases/{id}/events/export?format=csv` route not found (likely unimplemented or renamed).
- [ ] `GET /cases/{id}/events/export?format=json` route not found (likely unimplemented or renamed).
- [ ] `GET /cases/{id}/events?event_type=task&action=completed` route not found (likely unimplemented or renamed).
- [ ] `GET /cases/{id}/events?page=1&per_page=50` route not found (likely unimplemented or renamed).
- [ ] `POST /cases/{id}/events/verify` route not found (likely unimplemented or renamed).
### Remaining work
